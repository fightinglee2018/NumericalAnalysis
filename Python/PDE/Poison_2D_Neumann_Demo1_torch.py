...
# pn = torch.from_numpy(pn).cuda()
# g1 = torch.from_numpy(g1).cuda()
# g2 = torch.from_numpy(g2).cuda*()
# g3 = torch.from_numpy(g3).cuda()
# g4 = torch.from_numpy(g4).cuda()
